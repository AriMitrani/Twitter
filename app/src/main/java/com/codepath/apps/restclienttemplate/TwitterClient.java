...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final int NUM_TWEETS = 25;
	public int refreshes = 1;
	String tag = "clientpage";
	//public String maxID;
	...
	public void getMoreTimeline(JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", NUM_TWEETS);
		//maxID = String.valueOf(Integer.valueOf(TimelineActivity.getMaxID())-1);
		params.put("max_id", TimelineActivity.getMaxID());
		Log.e(tag, "Refreshes: "+refreshes);
		client.get(apiUrl, params, handler);
	}

	public void publishTweet(String content, JsonHttpResponseHandler handler) {
		Log.e(tag, "Made it to publishing!");
	...
	public void rtTweet(String tweetId, JsonHttpResponseHandler handler) {
		Log.e(tag, "Made it to Retweet!");
